...
import { Dropdown, DropdownList, MenuToggle, Icon } from '@patternfly/react-core';
...
const Bookmarks = ({
  ...
  const onToggle = () => {
    ...
    if (willOpen && bookmarks.length === 0 && status !== STATUS.PENDING) {
      getBookmarks();
    }
  };
  ...
  return (
    <>
      ...
      <Dropdown
        ...
        popperProps={{ position: bookmarksPosition === 'right' ? 'end' : 'start' }}
