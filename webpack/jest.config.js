...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    ...moduleNameMapper,
    '^@patternfly/react-styles/css/(.*)$': `${nodeModules}/identity-obj-proxy/src/index.js`,
    ...
    '^@patternfly/react-topology$': `${nodeModules}/@patternfly/react-topology/dist/js/index.js`,
