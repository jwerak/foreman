...
class OperatingsystemJSTest < IntegrationTestWithJavascript
  ...
  test "delete operating system" do
    ...
    assert_equal "Confirm", confirm_modal.find(".pf-v6-c-modal-box__title-text").text
    assert_equal "Delete #{os.title}?", confirm_modal.find(".pf-v6-c-modal-box__body").text
